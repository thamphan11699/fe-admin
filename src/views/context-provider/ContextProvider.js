...
import ContextProviderDialog from './ContextProviderDialog'
import { clear, getAll, getOne } from './ContextProviderService'
...
const ContextProvider = () => {
  ...
  const columns = [
    ...
    { title: 'Tên NCC', field: 'name', width: '20%', align: 'left' },
    { title: 'Mã NCC', field: 'code', width: '20%', align: 'left' },
    { title: 'Liên hệ', field: 'phoneNumber', width: '20%', align: 'left' },
    { title: 'Người đại diện', field: 'representative', width: '20%', align: 'left' },
    { title: 'Địa chỉ', field: 'address', width: '20%', align: 'left' },
    { title: 'Gi chú', field: 'description', width: '20%', align: 'left' },
  ]
